...
<head>
    ...
    <!-- PINK THEME SAMA SEPERTI all_product.php -->
    <style>
    :root {
...
<nav class="sb-topnav navbar navbar-expand sb-topnav">
    <a class="navbar-brand ps-3" href="index.php">Admin Beauty Store</a>
    <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle"><i class="fas fa-bars"></i></button>

    <ul class="navbar-nav ms-auto me-3">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" id="navbarDropdown" role="button" data-bs-toggle="dropdown">Admin</a>
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseLayouts">
                        <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>Pesanan
                    ...
                    <a class="nav-link active collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePages">
                        <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>Manajemen Produk
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active" style="color: var(--pink-primary)">Edit Produk & Hapus Produk</li>
                </ol>

                <div class="card mb-4">
                    <div class="card-header"><i class="fas fa-table me-1"></i>Barang Di Beauty Store</div>
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $brg["stok"] ?></td>
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal<?= $brg['id_barang'] ?>">Edit</button>
                                        <!-- MODAL EDIT -->
                                        <div class="modal fade" id="modal<?= $brg['id_barang'] ?>" tabindex="-1">
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <label class="pt-2">Nama Barang :</label>
                                                            <input type="text" name="nama_barang" class="form-control" value="<?= $brg["nama_barang"] ?>">

                                                            <label class="pt-3">Kategori :</label>
                                                            <select name="kategori" class="form-control">
                                                                <?php
                                                                $kategori = ["Headphone","Kipas Angin","Mesin Cuci","Television","Setrika","Audio Speaker","Microphone","Microwave","Monitor","Rice Cooker","Vacum Cleaner","Proyektor","Laptop","Lampu","Kulkas","AC","Dispenser","Kamera"];
                                                                foreach ($kategori as $kat) echo "<option value='$kat'>$kat</option>";
                                                                ?>
                                                            </select>

                                                            <label class="pt-3">Merk :</label>
                                                            <select name="merk" class="form-control">
                                                                <?php
                                                                $merk = ["Aqua Japan","Daikin","Polytron","Canon","Panasonic","LG","Acer","Philips","Fantech","Asus","Sanken","Midea","Lenovo","Sharp","Sony","Samsung","Logitech","Rexus"];
                                                                foreach ($merk as $m) echo "<option value='$m'>$m</option>";
                                                                ?>
                                                            </select>

                                                            <label class="pt-3">Harga :</label>
                                                            <input type="number" name="harga" class="form-control" min="1" value="<?= $brg["harga"] ?>">

                                                            <label class="pt-3">Keterangan :</label>
                                                            <textarea name="keterangan" class="form-control" rows="5"><?= $brg["keterangan"] ?></textarea>

                                                            <label class="pt-3">Gambar Produk (Opsional) :</label>
                                                            <input type="file" name="img" class="form-control" accept="image/*">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" name="edit_produk" class="btn btn-primary">Edit Barang</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
