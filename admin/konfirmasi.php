...
<head>
    ...
    <title>Konfirmasi Pesanan - Beauty Admin</title>
...
<!-- ===============================================
     🎀 PINK THEME — SAMA PERSIS DENGAN batal.php
     =============================================== -->
<style>
:root {
            ...
            <div class="nav">
                ...
                <div class="collapse show" id="pesanan">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link active" href="konfirmasi.php">Konfirmasi Pesanan</a>
...
<main>
    <div class="container-fluid px-4">
        ...
        <h1 class="mt-4">Konfirmasi Pesanan</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">List pesanan menunggu konfirmasi</li>
        </ol>

        <div class="card">
            <div class="card-header">
                <i class="fas fa-table me-1"></i> Data Konfirmasi Pesanan
            </div>
                    ...
                    <?php foreach ($orders as $ord) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal<?= $ord['id_orders'] ?>">Detail</button>

                                <!-- Konfirmasi action (calls processing script) -->
                                <a href="proses_konfirmasi.php?id=<?= $ord['id_orders'] ?>" 
                                   class="btn btn-primary btn-sm">
                                    Konfirmasi
                                </a>

                                <!-- Modal: show ordered items -->
                                <div class="modal fade" id="detailModal<?= $ord['id_orders'] ?>" tabindex="-1">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Detail Pesanan #<?= $ord['id_orders'] ?></h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="container pb-3">
                                                    ...
                                                    <?php
                                                        $ids = $ord["id_orders"];
                                                        $details = query("SELECT d.*, tb_barang.nama_barang, tb_barang.img, tb_barang.keterangan, j.nama_jasa, m.nama_metode, m.harga_admin FROM details d INNER JOIN tb_barang ON d.id_barang = tb_barang.id_barang INNER JOIN orders o ON d.id_orders = o.id_orders INNER JOIN jasa_kirim j ON o.id_jasa = j.id_jasa INNER JOIN metode m ON o.id_metode = m.id_metode WHERE d.id_orders = '$ids'");

                                                        $total = 0;
                                                        foreach ($details as $dt) {
                                                            $line = $dt["harga_satuan"] * $dt["qty"];
                                                            $total += $line;
                                                    ?>
                                            ...
                                            <div class="modal-footer">
                                                <a href="proses_konfirmasi.php?id=<?= $ord['id_orders'] ?>" class="btn btn-primary">Konfirmasi Pesanan</a>
