...
// Ambil tanggal awal dan akhir dari filter tanggal
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active" style="color: var(--pink-primary)">Pengeluaran</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-footer">
                            <a href="outcome.php?tanggal_awal=<?= $tanggal_awal ?>&tanggal_akhir=<?= $tanggal_akhir ?>" class="btn btn-primary">Export to Excel</a>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <script>
        ...
        document.getElementById('filterTanggal').addEventListener('click', function() {
            ...
            window.location.href = `pengeluaran.php?tanggal_awal=${tanggalAwal}&tanggal_akhir=${tanggalAkhir}`;
        });
    </script>
